function armor_pressed(){
    try {
        let jd = local_get('clarity_locations').exotic_armor
        ...
        if(perk_descriptions[perk_name] != undefined){
            ...
            // HTML comes from an external source controlled by me but for peace of mind I still use the "DOMPurify" sanitizer to clean it. Source sanitizer https://github.com/cure53/DOMPurify/ , Source HTML https://ice-mourne.github.io/Clarity-A-DIM-Companion-json/exotic_armor_perks/

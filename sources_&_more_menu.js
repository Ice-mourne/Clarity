...
function info_button_observer() {
    let jd = local_get('clarity_locations').sources_and_more_menu
...
function info_button(jd){
    // let clarity_menu = element_creator('div', {'textContent': 'Clarity menu', 'class': jd.button_class}) // create button 'Clarity menu'
    // document.querySelector(jd.header_button).prepend(clarity_menu)
...
function enable_dark_mode(){
    ...
    document.getElementById('dark_mode').textContent = `
        ...
        ${jd.dark_mode_line_4} {background-color: #0000; color: #dddddd; box-shadow: inset 0px -1px 7px 2px hsl(40deg 100% 50% / 40%);} 
        ${jd.dark_mode_line_5} {border: 1px solid #202031;}
        ${jd.dark_mode_line_6} {border-color: transparent;}
        ${jd.dark_mode_line_7} {color: #1379b4;}
        ${jd.dark_mode_line_8} {background-color: #ffffff00;}
        `
}
...
function open_menu() {
    document.getElementById('infoButton').addEventListener('click', _ => {

...
// let new_fragment = fragment_creator([
//     {
//         type: 'div',
//         textContent: 'text-1',
//         className: 'class-1',
...
// directions.split('.').reduce((acc, dir, index, array) => {
//     let data = (index == array.length - 1) ? 'some text' : {}
//     return acc[dir] = (some_object[dir]) ? some_object[dir] : data
// }, some_object)
// let stop
